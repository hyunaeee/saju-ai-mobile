 ...
 * ===================================================================== */
const { PRICES, productsFor, signToken, sendJson, readBody } = require("./_lib");
...
module.exports = async (req, res) => {
  ...
  const { paymentKey, orderId, amount, product, sig } = body || {};

  if (!paymentKey || !orderId || !product || !sig) return sendJson(res, 400, { ok: false, error: "missing" });
